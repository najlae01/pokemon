            ...
            Timer.after(1.5, function()
                ...
                :finish(function()
                    ...
                    if self.playerPokemon.currentExp > self.playerPokemon.expToLevel then
                        ...
                        self.startingHP = self.playerPokemon.HP
                        self.startingAtk = self.playerPokemon.attack
                        self.startingDf = self.playerPokemon.defense
                        self.startingSpeed = self.playerPokemon.speed
                        ...
                        self.HPIncrease, self.AtkIncrease, self.DfIncrease, self.SpeedIncrease = self.playerPokemon:levelUp()

                        gStateStack:push(BattleMessageState('Congratulations! Level Up!', function()
                            gStateStack:push(LevelUpStats(self, function()
                                self:fadeOutWhite()
                            end))
                        end))
                    else
